...
var KTAppInvoicesCreate = (function () {
  ...
  var updateTotal = function () {
    ...
    items.map(function (item) {
      ...
      item.querySelector('[data-kt-element="total"]').innerText = format.to(
    ...
    form.querySelector('[data-kt-element="sub-total"]').innerText =
      format.to(grandTotal);
    form.querySelector('[data-kt-element="grand-total"]').innerText =
      format.to(grandTotal);
  };
