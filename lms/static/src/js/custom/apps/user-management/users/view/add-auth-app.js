...
var KTUsersAddAuthApp = (function () {
  ...
  var initCodeSwap = () => {
    const qrCode = element.querySelector(
      '[ data-kt-add-auth-action="qr-code"]',
    );
    const textCode = element.querySelector(
      '[ data-kt-add-auth-action="text-code"]',
    );
    const qrCodeButton = element.querySelector(
      '[ data-kt-add-auth-action="qr-code-button"]',
    );
    const textCodeButton = element.querySelector(
      '[ data-kt-add-auth-action="text-code-button"]',
    );
    const qrCodeLabel = element.querySelector(
      '[ data-kt-add-auth-action="qr-code-label"]',
    );
    const textCodeLabel = element.querySelector(
