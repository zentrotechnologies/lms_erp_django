...
var KTChartsWidget34 = (function () {
  ...
  return {
    init: function () {
      var chart1Data = [
        2100, 2800, 2800, 2400, 2400, 1800, 1800, 2400, 2400, 3200, 3200, 2800,
        2800, 3250, 3250,
      ];
      var chart1Labels = [
        "10AM",
      ...
      var chart2Data = [
        2300, 2300, 2000, 3100, 3100, 2800, 2400, 2400, 3100, 2900, 3200, 3200,
        2600, 2600, 3200,
      ];
      var chart2Labels = [
        "Apr 01",
      ...
      var chart3Data = [
        2600, 3400, 2300, 2300, 2000, 3100, 3100, 2900, 3200, 3200, 2600, 3100,
        2800, 2400, 2400,
      ];
      var chart3Labels = [
        "Apr 02",
      ...
      var chart4Data = [
        1800, 1800, 2400, 2400, 3100, 3100, 3000, 2100, 3200, 3200, 2400, 2400,
        3000, 3200, 3100,
      ];
      var chart4Labels = [
        "Jun 2021",
      ...
      var chart5Data = [
        3000, 2100, 3200, 3200, 1800, 1800, 2400, 2400, 3100, 3100, 2400, 2400,
        3000, 2400, 2800,
      ];
      var chart5Labels = [
        "Sep 2021",
