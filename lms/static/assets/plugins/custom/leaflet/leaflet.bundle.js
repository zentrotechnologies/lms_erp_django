...
!(function (t, e) {
  ...
  (k.prototype = {
    ...
    distanceTo: function (t) {
      var e = (t = E(t)).x - this.x;
      t = t.y - this.y;
      return Math.sqrt(e * e + t * t);
    },
    equals: function (t) {
      return (t = E(t)).x === this.x && t.y === this.y;
    },
    contains: function (t) {
      return (
        (t = E(t)),
    ...
    (Z.prototype = {
      ...
      contains: function (t) {
        var e, i;
        return (
          (t = ("number" == typeof t[0] || t instanceof k ? E : B)(
            t,
          )) instanceof Z
            ? ((e = t.min), (i = t.max))
            : (e = i = t),
      ...
      pad: function (t) {
        ...
        return B(E(e.x - n, e.y - t), E(i.x + n, i.y + t));
      },
      equals: function (t) {
        return (
          !!t &&
  ...
  var Y = document.documentElement.style,
    ...
    _t = (Vi = "undefined" != typeof orientation || Ct("mobile")) && tt,
    mt = Vi && dt,
  ...
  var Mt = {
    ...
    Ot = { touchstart: At, touchmove: zt, touchend: It, touchcancel: kt },
    Et = {
  ...
  function oe(t, e) {
    return void 0 !== t.classList
      ...
      : 0 < (t = he(t)).length && new RegExp("(^|\\s)" + e + "(\\s|$)").test(t);
  }
  function se(t, e) {
    var i;
    if (void 0 !== t.classList)
      for (var n = d(e), o = 0, s = n.length; o < s; o++) t.classList.add(n[o]);
    else oe(t, e) || ae(t, ((i = he(t)) ? i + " " : "") + e);
  }
  function re(t, e) {
    void 0 !== t.classList
      ? t.classList.remove(e)
      : ae(t, c((" " + he(t) + " ").replace(" " + e + " ", " ")));
  }
  function ae(t, e) {
  ...
  function fe(t) {
    ...
    t.style &&
      (ge(),
      (Vt = (Ht = t).style.outlineStyle),
      (t.style.outlineStyle = "none"),
      xe(window, "keydown", ge));
  }
  function ge() {
    Ht &&
      ((Ht.style.outlineStyle = Vt),
      (Vt = Ht = void 0),
      we(window, "keydown", ge));
  }
  function ve(t) {
    for (
      ;
  ...
  function xe(t, e, i, n) {
    if (e && "object" == typeof e) for (var o in e) Te(t, o, e[o], i);
    else for (var s = 0, r = (e = d(e)).length; s < r; s++) Te(t, e[s], i, n);
    return this;
  }
  (Wt =
    "onselectstart" in document
      ? ((qt = function () {
          xe(window, "selectstart", ze);
        }),
        function () {
      ...
      : ((Gt = ue([
        ...
        function () {
          Gt && ((document.documentElement.style[Gt] = jt), (jt = void 0));
        })),
    (Q = {
      __proto__: null,
      TRANSFORM: Kt,
      ...
      preventOutline: fe,
      restoreOutline: ge,
      getSizedParentNode: ve,
      getScale: ye,
    });
  var be = "_leaflet_events";
  function we(t, e, i, n) {
    if (1 === arguments.length) Le(t), delete t[be];
    else if (e && "object" == typeof e) for (var o in e) Se(t, o, e[o], i);
      ...
      (i = t[be] && t[be][o]) &&
        (!Mt.touchNative && Mt.pointer && 0 === e.indexOf("touch")
          ? ((n = t),
            (a = i),
            Ot[(s = e)]
              ? n.removeEventListener(Ot[s], a, !1)
          ...
          : Mt.touch && "dblclick" === e
            ...
            : "removeEventListener" in t
              ? t.removeEventListener(Pe[e] || e, i, !1)
  ...
  function Me(t) {
    return Te(t, "wheel", Ce), this;
  }
  function Ae(t) {
    return (
      xe(t, "mousedown touchstart dblclick contextmenu", Ce),
    ...
    De = I.extend({
      ...
      initialize: function (t, e) {
        (e = p(this, e)),
          ...
          this.callInitHooks(),
          (this._zoomAnimated =
            Jt && Mt.any3d && !Mt.mobileOpera && this.options.zoomAnimation),
          this._zoomAnimated &&
            (this._createAnimProxy(),
            xe(this._proxy, Yt, this._catchTransitionEnd, this)),
      ...
      panInside: function (t, e) {
        var i = E((e = e || {}).paddingTopLeft || e.padding || [0, 0]),
          n = E(e.paddingBottomRight || e.padding || [0, 0]),
      ...
      layerPointToLatLng: function (t) {
        return (t = E(t).add(this.getPixelOrigin())), this.unproject(t);
      },
      ...
      containerPointToLatLng: function (t) {
        return (
          (t = this.containerPointToLayerPoint(E(t))),
      ...
      _initContainer: function (t) {
        if (!(t = this._container = Qt(t)))
          throw new Error("Map container not found.");
        if (t._leaflet_id)
          throw new Error("Map container is already initialized.");
        xe(t, "scroll", this._onScroll, this), (this._containerId = r(t));
      },
      ...
      _handleDOMEvent: function (t) {
        ...
        !this._loaded ||
          ...
          ("mousedown" === (e = t.type) && fe(i), this._fireDOMEvent(t, e));
      },
      _mouseEvents: [
        "click",
        "dblclick",
      ...
      _getMapPanePos: function () {
        return pe(this._mapPane) || new k(0, 0);
      },
      _moved: function () {
        var t = this._getMapPanePos();
      ...
      _limitOffset: function (t, e) {
        var i;
        return e
          ? ((i = new Z((i = this.getPixelBounds()).min.add(t), i.max.add(t))),
      ...
      _onZoomTransitionEnd: function () {
        this._animatingZoom &&
          (this._mapPane && re(this._mapPane, "leaflet-zoom-anim"),
  ...
  var Ne = A.extend({
        ...
        expand: function () {
          ...
          return (
            t < this._section.clientHeight
              ...
              : re(this._section, "leaflet-control-layers-scrollbar"),
          ...
          var e,
            ...
            o =
              (((n =
                ...
                (e.layerId = r(t.layer)),
                xe(e, "click", this._onInputClick, this),
        ...
        _expandSafely: function () {
          var t = this._section,
            e =
              ...
              this);
          setTimeout(function () {
            we(t, "click", ze), (e._preventClick = !1);
          });
        },
      })),
    je = Ne.extend({
      ...
      _createButton: function (t, e, i, n, o) {
        return (
          ...
          xe(i, "click", Ie),
          xe(i, "click", o, this),
          xe(i, "click", this._refocusOnMap, this),
          i
        );
      },
      _updateDisabled: function () {
        var t = this._map,
          e = "leaflet-disabled";
        re(this._zoomInButton, e),
          re(this._zoomOutButton, e),
    ...
    qe = Ne.extend({
      ...
      onAdd: function (t) {
        for (var e in (((t.attributionControl = this)._container = $t(
          "div",
    ...
    He = I.extend({
      ...
      enable: function () {
        this._enabled ||
          (xe(this._dragStartTarget, We, this._onDown, this),
          (this._enabled = !0));
      },
      disable: function () {
        this._enabled &&
          (He._dragging === this && this.finishDrag(!0),
          we(this._dragStartTarget, We, this._onDown, this),
          (this._enabled = !1),
          (this._moved = !1));
      },
      _onDown: function (t) {
        ...
        this._enabled &&
          ((this._moved = !1),
          oe(this._element, "leaflet-zoom-anim") ||
            (t.touches && 1 !== t.touches.length
              ? He._dragging === this && this.finishDrag()
              : He._dragging ||
                t.shiftKey ||
                (1 !== t.which && 1 !== t.button && !t.touches) ||
                ((He._dragging = this)._preventOutline && fe(this._element),
                _e(),
                qt(),
                this._moving ||
                  (this.fire("down"),
      ...
      finishDrag: function (t) {
        re(document.body, "leaflet-dragging"),
          this._lastTarget &&
            (re(this._lastTarget, "leaflet-drag-target"),
    ...
    for (s = 0; s < 4; s++) {
      for (h = u[s], n = [], c = 0, o = (d = t.length) - 1; c < d; o = c++)
        (r = t[c]),
          ...
          r._code & h
            ? a._code & h ||
              (((l = ti(a, r, h, e, i))._code = ei(l, e)), n.push(l))
            : (a._code & h &&
                (((l = ti(a, r, h, e, i))._code = ei(l, e)), n.push(l)),
              n.push(r));
      t = n;
  ...
  function Ke(t, e) {
    ...
    for (
      ...
      var _ = N(t[p]);
      d.push(e.project(N([_.lat - l.lat, _.lng - l.lng])));
    }
    for (p = r = a = h = 0, i = c - 1; p < c; i = p++)
      (n = d[p]),
        (o = d[i]),
        (s = n.y * o.x - o.y * n.x),
        (a += (n.x + o.x) * s),
    ...
    return (
      (u = 0 === r ? d[0] : [a / r, h / r]),
      N([(u = e.unproject(E(u))).lat + l.lat, u.lng + l.lng])
    );
  }
  function Je(t) {
  ...
  var Ye;
  et = { __proto__: null, clipPolygon: Ve, polygonCenter: Ke, centroid: Je };
  function Qe(t, e) {
    if (e && t.length) {
  ...
  function si(t, e) {
    ...
    for (
      ...
      var p = N(t[d]);
      c.push(e.project(N([p.lat - h.lat, p.lng - h.lng])));
    }
    ...
    return N([(l = e.unproject(E(a))).lat + h.lat, l.lng + h.lng]);
  }
  (it = {
    __proto__: null,
    simplify: Qe,
  ...
  var ri = e({}, j, {
      ...
      addLayer: function (t) {
        return this.hasLayer(t)
          ...
          : (t.addEventParent(this),
            ai.prototype.addLayer.call(this, t),
      ...
      removeLayer: function (t) {
        return this.hasLayer(t)
          ? ((t = t in this._layers ? this._layers[t] : t).removeEventParent(
            ...
            ai.prototype.removeLayer.call(this, t),
    ...
    li = A.extend({
      ...
      _setIconStyles: function (t, e) {
        var i = this.options,
          n = E((n = "number" == typeof (n = i[e + "Size"]) ? [n, n] : n)),
          o = E(
      ...
      _getIconUrl: function (t) {
        return (
          ...
          (this.options.imagePath || ui.imagePath) +
            li.prototype._getIconUrl.call(this, t)
        );
      },
    ...
    ci = $.extend({
      ...
      removeHooks: function () {
        this._draggable
          ...
          .disable(),
          this._marker._icon &&
            re(this._marker._icon, "leaflet-marker-draggable");
      },
      moved: function () {
      ...
      _adjustPan: function (t) {
        ...
        (a = B(
          ...
          de(e._icon, this._draggable._newPos),
          this._onDrag(t),
    ...
    di = lt.extend({
      ...
      _initIcon: function () {
        ...
        (t =
          ...
          this.options.autoPanOnFocus && xe(t, "focus", this._panOnFocus, this),
      ...
      _panOnFocus: function () {
        ...
        i &&
          ((t = (e = this.options.icon.options).iconSize
            ? E(e.iconSize)
            : E(0, 0)),
          (e = e.iconAnchor ? E(e.iconAnchor) : E(0, 0)),
    ...
    mi = _i.extend({
      ...
      closestLayerPoint: function (t) {
        for (
          var e = 1 / 0, i = null, n = ii, o = 0, s = this._parts.length;
          o < s;
          o++
        )
        ...
        if (this._pxBounds && this._pxBounds.contains(t))
          for (i = 0, s = this._parts.length; i < s; i++)
            for (
              ...
              if ((e || 0 !== n) && Xe(t, a[o], a[n]) <= h) return !0;
        return !1;
      },
    });
  fi._flat = oi;
  var gi = fi.extend({
      ...
      getCenter: function () {
        if (this._map) return Ke(this._defaultShape(), this._map.options.crs);
        throw new Error("Must add layer to map before using getCenter()");
      },
      _convertLatLngs: function (t) {
        var e = (t = fi.prototype._convertLatLngs.call(this, t)).length;
        return (
          2 <= e && t[0] instanceof F && t[0].equals(t[e - 1]) && t.pop(), t
        );
      },
      _setLatLngs: function (t) {
        fi.prototype._setLatLngs.call(this, t),
        ...
        if (
          ...
          if (this.options.noClip) this._parts = this._rings;
            ...
            for (var i, n = 0, o = this._rings.length; n < o; n++)
              (i = Ve(this._rings[n], t, !0)).length && this._parts.push(i);
      },
      _updatePath: function () {
          ...
          for (s = 0, r = (h = (e = this._parts[o]).length) - 1; s < h; r = s++)
            (i = e[s]),
              ...
              i.y > t.y != n.y > t.y &&
                ...
                (l = !l);
        return l || fi.prototype._containsPoint.call(this, t, !0);
      },
    }),
    vi = hi.extend({
      initialize: function (t, e) {
      ...
      addData: function (t) {
        ...
        var s,
          r = this.options;
        return (r.filter && !r.filter(t)) || !(s = yi(t, r))
          ? this
          : ((s.feature = Si(t)),
  ...
  function yi(t, e) {
    ...
    switch (r.type) {
      case "Point":
        return xi(l, t, (i = u(a)), e);
      case "MultiPoint":
        for (o = 0, s = a.length; o < s; o++)
          (i = u(a[o])), h.push(xi(l, t, i, e));
        return new hi(h);
      case "LineString":
      case "MultiLineString":
        return (n = wi(a, "LineString" === r.type ? 0 : 1, u)), new fi(n, e);
      case "Polygon":
      case "MultiPolygon":
        return (n = wi(a, "Polygon" === r.type ? 1 : 2, u)), new gi(n, e);
  ...
  function wi(t, e, i) {
    for (var n, o = [], s = 0, r = t.length; s < r; s++)
      (n = e ? wi(t[s], e - 1, i) : (i || bi)(t[s])), o.push(n);
    return o;
  }
  function Li(t, e) {
  ...
  function Pi(t, e, i, n) {
    for (var o = [], s = 0, r = t.length; s < r; s++)
      o.push(e ? Pi(t[s], ni(t[s]) ? 0 : e - 1, i, n) : Li(t[s], n));
    return !e && i && 0 < o.length && o.push(o[0].slice()), o;
  }
  function Ti(t, i) {
    return t.feature ? e({}, t.feature, { geometry: i }) : Si(i);
  }
  function Si(t) {
  ...
  (ut = {
    toGeoJSON: function (t) {
      return Ti(this, { type: "Point", coordinates: Li(this.getLatLng(), t) });
    },
  }),
    di.include(ut),
    mi.include(ut),
    ...
    ai.include({
      toMultiPoint: function (t) {
        ...
        return (
          ...
          Ti(this, { type: "MultiPoint", coordinates: e })
        );
      },
      toGeoJSON: function (t) {
        var e,
          ...
          : ((e = "GeometryCollection" === n),
            ...
            this.eachLayer(function (n) {
              n.toGeoJSON &&
                ...
                e
                  ? i.push(n.geometry)
                  : "FeatureCollection" === (n = Si(n)).type
                    ? i.push.apply(i, n.features)
                    : i.push(n));
            }),
            e
              ? Ti(this, { geometries: i, type: "GeometryCollection" })
    ...
    Ii = lt.extend({
      ...
      onAdd: function (t) {
        (this._zoomAnimated = t._zoomAnimated),
          ...
          t._fadeAnimated && le(this._container, 0),
          clearTimeout(this._removeTimeout),
          this.getPane().appendChild(this._container),
          this.update(),
          t._fadeAnimated && le(this._container, 1),
          this.bringToFront(),
          this.options.interactive &&
      ...
      Ii.extend({
        ...
        openOn: function (t) {
          return (
            ...
            (t._popup = this),
            Ii.prototype.openOn.call(this, t)
          );
        },
        onAdd: function (t) {
          Ii.prototype.onAdd.call(this, t),
            ...
            this._source &&
              ...
              this._source instanceof pi || this._source.on("preclick", Ce));
        },
        onRemove: function (t) {
          Ii.prototype.onRemove.call(this, t),
            ...
            this._source &&
              ...
              this._source instanceof pi || this._source.off("preclick", Ce));
        },
        getEvents: function () {
        ...
        _initLayout: function () {
          ...
          (this._contentNode = $t("div", t + "-content", i)),
            ...
            this.options.closeButton &&
              ((i = this._closeButton =
                $t("a", t + "-close-button", e)).setAttribute("role", "button"),
        ...
        _adjustPan: function () {
          ...
          this.options.autoPan &&
            ...
            this._autopanning
              ? (this._autopanning = !1)
              : ((t = this._map),
                (e = parseInt(Xt(this._container, "marginBottom"), 10) || 0),
                ...
                (n = E(this.options.autoPanPaddingTopLeft || o)),
                (o = E(this.options.autoPanPaddingBottomRight || o)),
                (s = t.getSize()),
                (r = 0),
    ...
    Oi =
      ...
      lt.include({
        bindPopup: function (t, e) {
          return (
            (this._popup = this._initOverlay(ki, this._popup, t, e)),
        ...
        openPopup: function (t) {
          return (
            this._popup &&
              (this instanceof hi || (this._popup._source = this),
        ...
        _openPopup: function (t) {
          ...
          this._popup &&
            ...
            (Ie(t),
            (e = t.layer || t.target),
            this._popup._source !== e || e instanceof pi
      ...
      Ii.extend({
        ...
        _setPosition: function (t) {
          ...
          (t = t
            ...
            .add(h)
            .add(l)),
            re(n, "leaflet-tooltip-right"),
            re(n, "leaflet-tooltip-left"),
            re(n, "leaflet-tooltip-top"),
            re(n, "leaflet-tooltip-bottom"),
            se(n, "leaflet-tooltip-" + s),
            de(n, t);
        },
        _updatePosition: function () {
      ...
      lt.include({
        bindTooltip: function (t, e) {
          return (
            ...
            (this._tooltip = this._initOverlay(Oi, this._tooltip, t, e)),
        ...
        openTooltip: function (t) {
          return (
            this._tooltip &&
              (this instanceof hi || (this._tooltip._source = this),
        ...
        _addFocusListenersOnLayer: function (t) {
          ...
          e &&
            ...
            xe(e, "blur", this.closeTooltip, this));
        },
  ...
  var Zi = lt.extend({
      ...
      bringToBack: function () {
        return (
          this._map && (ne(this._container), this._setAutoZIndex(Math.min)),
          this
        );
      },
      getContainer: function () {
      ...
      _setZoomTransform: function (t, e, i) {
        ...
        e = t.origin
          ...
          .round();
        Mt.any3d ? ce(t.el, e, n) : de(t.el, e);
      },
      _resetGrid: function () {
        var t = this._map,
          e = t.options.crs,
      ...
      _initTile: function (t) {
        ...
        (t.style.width = e.x + "px"),
          ...
          (t.onselectstart = l),
          (t.onmousemove = l),
          Mt.ielt9 && this.options.opacity < 1 && le(t, this.options.opacity);
      },
    ...
    Bi = Zi.extend({
      ...
      createTile: function (t, e) {
        ...
        return (
          xe(i, "load", o(this._tileOnLoad, this, e, i)),
          xe(i, "error", o(this._tileOnError, this, e, i)),
          (!this.options.crossOrigin && "" !== this.options.crossOrigin) ||
            (i.crossOrigin =
              !0 === this.options.crossOrigin ? "" : this.options.crossOrigin),
  ...
  var Di = Bi.extend({
    ...
    onAdd: function (t) {
      ...
      (this.wmsParams[e] = this._crs.code), Bi.prototype.onAdd.call(this, t);
    },
    getTileUrl: function (t) {
      var e = this._tileCoordsToNwSe(t),
        i =
          ...
          i.max);
      e = (
        1.3 <= this._wmsVersion && this._crs === ri
          ? [e.y, e.x, i.y, i.x]
          : [e.x, e.y, i.x, i.y]
      ).join(",");
      return (
        (i = Bi.prototype.getTileUrl.call(this, t)) +
  ...
  var Fi = lt.extend({
      ...
      onAdd: function () {
        this._container ||
          (this._initContainer(), se(this._container, "leaflet-zoom-animated")),
          this.getPane().appendChild(this._container),
          this._update(),
      ...
      _updateTransform: function (t, e) {
        ...
        Mt.any3d ? ce(this._container, n, i) : de(this._container, n);
      },
      _reset: function () {
    ...
    Ni = Fi.extend({
      options: { tolerance: 0 },
      getEvents: function () {
        var t = Fi.prototype.getEvents.call(this);
      ...
      _initContainer: function () {
        ...
        xe(t, "mousemove", this._onMouseMove, this),
          xe(
            t,
          ...
          xe(t, "mouseout", this._handleMouseOut, this),
      ...
      _update: function () {
        ...
        (this._map._animatingZoom && this._bounds) ||
          (Fi.prototype._update.call(this),
          (t = this._bounds),
          (e = this._container),
          (i = t.getSize()),
          (n = Mt.retina ? 2 : 1),
  ...
  function Ui(t) {
    return Mt.canvas ? new Ni(t) : null;
  }
  var ji = (function () {
      try {
        return (
    ...
    Gi =
      ((dt = {
        ...
        _update: function () {
          this._map._animatingZoom ||
            (Fi.prototype._update.call(this), this.fire("update"));
        },
        _initPath: function (t) {
        ...
        _removePath: function (t) {
          var e = t._container;
          te(e), t.removeInteractiveTarget(e), delete this._layers[r(t)];
        },
        _updateStyle: function (t) {
          var e = t._stroke,
            i = t._fill,
  ...
  function Wi(t) {
    return Mt.svg || Mt.vml ? new qi(t) : null;
  }
  Mt.vml && qi.include(dt),
    De.include({
      ...
      _createRenderer: function (t) {
        return (this.options.preferCanvas && Ui(t)) || Wi(t);
      },
    });
  var Hi = gi.extend({
    initialize: function (t, e) {
  ...
  (qi.create = Gi),
    (qi.pointsToPath = J),
    (vi.geometryToLayer = yi),
    (vi.coordsToLatLng = bi),
    (vi.coordsToLatLngs = wi),
    (vi.latLngToCoords = Li),
    (vi.latLngsToCoords = Pi),
    (vi.getFeature = Ti),
    (vi.asFeature = Si),
  ...
  (Y = $.extend({
    ...
    _finish: function () {
      this._moved && (te(this._box), re(this._container, "leaflet-crosshair")),
        Wt(),
        me(),
        we(
          document,
    ...
    De.addInitHook("addHandler", "boxZoom", Y),
  ...
  var Vi =
      ...
      $.extend({
        ...
        removeHooks: function () {
          re(this._map._container, "leaflet-grab"),
            re(this._map._container, "leaflet-touch-drag"),
    ...
    Ki =
      ((_t =
        (De.addInitHook("addHandler", "dragging", Vi),
            ...
            if (!(t.altKey || t.ctrlKey || t.metaKey)) {
              ...
              if (n in this._panKeys)
                (o._panAnim && o._panAnim._inProgress) ||
                  ((i = this._panKeys[n]),
                  t.shiftKey && (i = E(i).multiplyBy(3)),
                  o.options.maxBounds &&
                    (i = o._limitOffset(E(i), o.options.maxBounds)),
      ...
      (mt =
        ...
        $.extend({
          addHooks: function () {
            xe(this._map._container, "wheel", this._onWheelScroll, this),
              (this._delta = 0);
          },
          removeHooks: function () {
          ...
          _onDown: function (t) {
            ...
            clearTimeout(this._holdTimeout),
              1 === t.touches.length &&
                ...
                xe(document, "touchmove", this._onMove, this));
          },
      ...
      (gt =
        ...
        De.mergeOptions({ touchZoom: Mt.touch, bounceAtZoomLimits: !0 }),
        $.extend({
          addHooks: function () {
            se(this._map._container, "leaflet-touch-zoom"),
              xe(this._map._container, "touchstart", this._onTouchStart, this);
          },
          removeHooks: function () {
            re(this._map._container, "leaflet-touch-zoom"),
          ...
          _onTouchStart: function (t) {
            ...
            !t.touches ||
              ...
              (this._zooming = !0),
              n._stop(),
              xe(document, "touchmove", this._onTouchMove, this),
              xe(document, "touchend touchcancel", this._onTouchEnd, this),
              ze(t));
          },
  ...
  (function (t, e) {
    "object" == typeof exports && "undefined" != typeof module
      ...
      : "function" == typeof define && define.amd
        ...
        : e(
            (((t =
              "undefined" != typeof globalThis ? globalThis : t || self).L =
              t.L || {}),
            (t.L.esri = {})),
            t.L,
          );
    ...
    function I(t) {
      for (var e in t.attributes) if (e.match(A)) return e;
    }
    function k(t, e) {
      var i,
            ...
            (n.type = "text/css"),
              ...
              t.on("resize", function (e) {
                t.attributionControl &&
                  (t.attributionControl._container.style.maxWidth = R(
                    e.target,
                  ));
              }),
    ...
    function N(t) {
      ...
      return t instanceof e.LatLngBounds
        ? ((i.geometry = M(t)), (i.geometryType = "esriGeometryEnvelope"), i)
        : (t.getLatLng && (t = t.getLatLng()),
          ...
          "Polygon" === t.type ||
          "MultiPolygon" === t.type
            ? ((i.geometry = T(t)), (i.geometryType = B(t.type)), i)
            : void _(
      ...
      W = q.extend({
        ...
        run: function (t, e) {
          return (
            ...
            (Z(this.options.url) && void 0 === this.options.isModern)
              ? ((this.params.f = "geojson"),
                this.request(function (i, n) {
                  this._trapSQLerrors(i), t.call(e, i, n, n);
                }, this))
              : this.request(function (i, n) {
                  this._trapSQLerrors(i), t.call(e, i, n && k(n), n);
                }, this)
          );
        },
        count: function (t, e) {
        ...
        bounds: function (t, e) {
          return (
            ...
            this.request(function (i, n) {
              n && n.extent && C(n.extent)
                ? t.call(e, i, C(n.extent), n)
    ...
    var at = "https:" !== window.location.protocol ? "http:" : "https:",
      ...
      lt = e.TileLayer.extend({
        ...
        initialize: function (t) {
          (t = E((t = e.Util.setOptions(this, t)))),
            (this.tileUrl =
              (t.proxy ? t.proxy + "?" : "") +
              t.url +
              "tile/{z}/{y}/{x}" +
            ...
            e.Util.extend(
              {
                ...
                y: t.y,
                z:
                  this._lodMap && void 0 !== this._lodMap[i]
                    ? this._lodMap[i]
                    : i,
              },
              this.options,
              ...
              this.metadata(function (i, n) {
                if (!i && n.spatialReference) {
                  ...
                  if (
                    ...
                    this._lodMap = {};
                    for (
                      var s = n.tileInfo.lods, r = lt.MercatorZoomLevels, a = 0;
                      a < s.length;
                      a++
                    ) {
                      var h = s[a];
        ...
        onRemove: function (t) {
          F(t), e.TileLayer.prototype.onRemove.call(this, t);
        },
        metadata: function (t, e) {
    ...
    var ft = _t.extend({
        ...
        initialize: function (t) {
          ...
          this.options.timeField.start && this.options.timeField.end
            ? ((this._startTimeIndex = new mt()),
              (this._endTimeIndex = new mt()))
        ...
        onAdd: function (t) {
          return (
            ...
            _t.prototype.onAdd.call(this, t)
          );
        },
        onRemove: function (t) {
          return (
            ...
            _t.prototype.onRemove.call(this, t)
          );
        },
        getAttribution: function () {
          return this.options.attribution;
      ...
      gt = ft.extend({
        ...
        _redraw: function (t) {
          ...
          i && i.setStyle && this.options.style && this.resetFeatureStyle(n.id);
        },
        openPopup(t) {
          return (
            this._popup &&
    ...
    (t.BasemapLayer = ht),
      ...
      (t.service = function (t) {
        return (t = E(t)), new tt(t);
      }),
      (t.task = function (t) {
        return (t = E(t)), new q(t);
      }),
