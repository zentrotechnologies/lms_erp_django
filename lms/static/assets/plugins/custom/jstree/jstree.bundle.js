   ...
   */ if (!e.jstree) {
    ...
    !c &&
      ...
      (e.jstree.core.prototype = {
            ...
            this._load_node(
              ...
              function (r) {
                ...
                t.state.loaded &&
                  a &&
                  a.length &&
                  (a.removeClass("jstree-closed jstree-open jstree-leaf"),
                  d
                    ? "#" !== t.id &&
                      a.addClass(
                        t.state.opened ? "jstree-open" : "jstree-closed",
                      )
                    : a.addClass("jstree-leaf")),
                  t.id !== e.jstree.root
                    ? a.children(".jstree-anchor").attr("aria-busy", !1)
                    : a.attr("aria-busy", !1),
        ...
        copy: function (i) {
          if (
            (i || (i = this._data.core.selected.concat()),
            e.vakata.is_array(i) || (i = [i]),
            !i.length)
          )
            return !1;
      ...
      (e.jstree.plugins.checkbox = function (i, r) {
        (this.bind = function () {
          ...
          (this.delete_node = function (t) {
            ...
            if (!(t = this.get_node(t)) || t.id === e.jstree.root) return !1;
            for (
              (i = t.children_d.concat([])).push(t.id), s = 0, a = i.length;
              s < a;
              s++
            )
        ...
        (this.init = function (i, s) {
          ...
          (this.get_json = function (t, i, s) {
            ...
            if (e.vakata.is_array(c))
              ...
              (c.type =
                (c.id || 0 === c.id) && o[c.id] && o[c.id].type
                  ? o[c.id].type
                  : "default"),
