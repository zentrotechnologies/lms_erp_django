...
var FullCalendar = (function (e) {
    ...
    for (n.__k = [], c = 0; c < t.length; c++)
      if (
        ...
        if (
          ((v.__ = n),
          (v.__b = n.__b + 1),
          null === (p = S[c]) || (p && v.key == p.key && v.type === p.type))
        )
          S[c] = void 0;
        else
          for (d = 0; d < w; d++) {
    ...
    try {
      e: if ("function" == typeof _) {
        if (
          ...
          null != d.componentWillUpdate && d.componentWillUpdate(y, d.__s, S),
        ...
        (d.state = d.__s),
          ...
          (k =
            null != c && c.type === b && null == c.key ? c.props.children : c),
    ...
    if (null === v) p === h || (l && e.data === h) || (e.data = h);
      ...
      if (
        ((function (e, t, n, r, o) {
          var i;
          for (i in n)
            "children" === i || "key" === i || i in t || w(e, i, null, n[i], r);
          for (i in t)
          ...
          ("defaultValue" === i && "value" in n && null == n.value
            ...
            : "download" === i && !0 === a
              ...
              : /ondoubleclick/i.test(i)
                ? (i = "ondblclick")
                : /^onchange(textarea|input)/i.test(i + t) && !be(n.type)
                  ? (i = "oninput")
                  : /^onfocus$/i.test(i)
                    ? (i = "onfocusin")
                    : /^onblur$/i.test(i)
      ...
      return (
        ...
        (e.prototype.triggerEventAdd = function (e) {
          ...
          this.getCurrentData().emitter.trigger("eventAdd", {
            ...
            relatedEvents: [],
            revert: function () {
              t.dispatch({ type: "REMOVE_EVENTS", eventStore: zr(e) });
            },
          });
        }),
      ...
      return (
        (e.prototype.setProp = function (e, t) {
          ...
          if (e in jn)
            ...
            (t = Bn[e](t)), this.mutate({ standardProps: { publicId: t } });
          else if (e in Bn)
            (t = Bn[e](t)),
          ...
          return "local" === this.timeZone
            ...
            : "UTC" === this.timeZone
              ...
              : this.namedTimeZoneImpl
                ? new Date(
                    e.valueOf() -
                      1e3 * this.namedTimeZoneImpl.offsetForArray(xt(e)) * 60,
                  )
  ...
  function ui() {
    ...
    return function (r, o) {
      return (
        (t && Ot(t, o) && r === e) || ((e = r), (t = o), (n = ci(r, o))), n
      );
    };
  }
  function ci(e, t) {
      ...
      n.content &&
        ...
        (o = function (e) {
          return Lo(qo.Consumer, null, function (n) {
            return Lo(pi, { viewSpec: n.viewSpec }, function (o, i) {
              var a = r(r({}, e), {
      ...
      (e.prototype.adjustActiveRange = function (e) {
        ...
        return (
          r &&
            ...
            Xt(i) > 1 && ((s = ft((s = bt(s)), -1)), (s = n.add(s, i)))),
          { start: a, end: s }
        );
      }),
    ...
    function e(e) {
      ...
      var s,
        ...
        c =
          ((s = o.calendarOptions),
          (l = o.dateEnv),
          null != (u = s.initialDate) ? l.createMarker(u) : Ur(s.now, l)),
        ...
        for (var f in a)
          a[f] === u[f] || (xn[f] && xn[f](a[f], u[f]))
            ...
            : (a[f] === this.currentCalendarOptionsInput[f] ||
              (xn[f] && xn[f](a[f], this.currentCalendarOptionsInput[f]))
    ...
    ra = (function () {
      ...
      return (
        ...
        (e.prototype.findInsertion = function (e) {
          ...
          var b = -1;
          return (
            E < a && n[E] === s && (b = ca(r[E], e.span.end, oa)[0]),
            {
              touchingLevel: l,
              touchingLateral: u,
              touchingEntry: c,
      ...
      return (
        ...
        (t.prototype.renderWidgetGroup = function (e) {
          ...
          if (r.length > 1) {
            ...
            return Lo.apply(void 0, o(["div", { className: m }], r));
          }
          return r[0];
        }),
        t
    ...
    Sa = (function (e) {
      function t(t) {
        ...
        return (
          ...
          (n.destroy = Be(t.el, "click", ".fc-event", n.handleSegClick)),
          n
        );
      }
      return n(t, e), t;
          ...
          for (var m in u) {
            ...
            for (var T in f) {
              ...
              if (or(E, x.range)) {
                ...
                if (D && !D(new Vr(t, p[x.defId], x), new Vr(t, S, y)))
                  return !1;
              }
            }
            for (var C = i.eventStore, k = 0, _ = b.allows; k < _.length; k++) {
              var R = _[k],
                ...
                P = C.instances[m],
                N = void 0;
              if (((N = I ? new Vr(t, I, P) : new Vr(t, S)), !R(Rr(M, t), N)))
                return !1;
            }
          }
          return !0;
    ...
    return (
      ...
      (t.prototype.render = function () {
        ...
        return Lo(
          ...
          Boolean(!v && p.length) && Lo.apply(void 0, o(["thead", g], p)),
          Boolean(!v && f.length) && Lo.apply(void 0, o(["tbody", g], f)),
          Boolean(!v && h.length) && Lo.apply(void 0, o(["tfoot", g], h)),
  ...
  ds.addStateEquality({ scrollerClientWidths: Ot, scrollerClientHeights: Ot });
  var ps = (function (e) {
      function t() {
        var t = (null !== e && e.apply(this, arguments)) || this;
        return (t.elRef = Wo()), t;
  ...
  function ws(e) {
    return (
      e.event.title && Lo("div", { className: "fc-event-title" }, e.event.title)
    );
  }
  var Ds = function (e) {
    return Lo(qo.Consumer, null, function (t) {
  ...
  function Rs(e) {
    ...
    var t,
      n = e.hiddenSegs;
    return { start: Ms(n), end: ((t = n), t.reduce(Ps).eventRange.range.end) };
  }
  function Ms(e) {
                  ...
                  function (t, n, i, a) {
                    return (
                      ...
                      Lo(
                        ...
                        Lo(Da, r({ isHeightAuto: i, forPrint: a }, e)),
                      )
                    );
                  },
                ),
    ...
    Ls = (function () {
      function e(e) {
        ...
        (this.subjectEl = null),
          ...
          1 === (As += 1) &&
            window.addEventListener("touchmove", Us, { passive: !1 });
      }
      return (
        (e.prototype.destroy = function () {
          this.containerEl.removeEventListener(
            ...
            (As -= 1) ||
              window.removeEventListener("touchmove", Us, { passive: !1 });
        }),
  ...
  function Zs(e, t) {
    return (
      (!e && !t) || (Boolean(e) === Boolean(t) && xr(e.dateSpan, t.dateSpan))
    );
  }
  function Xs(e, t) {
    for (
          ...
          (n.handleHitUpdate = function (e, t) {
            ...
            if (e) {
              ...
              (e.componentId === s.componentId &&
                ...
                (i && Fa(i, e.dateProfile, o)) || ((a = !0), (i = null));
            }
            i
            ...
            if (e) {
              ...
              i === a || (d.editable && d.droppable)
                ? (s = (function (e, t, n) {
                  ...
                  ((l = Ir(n, a.getCurrentData().eventUiBases, s, a)),
                  (c.mutatedEvents = l),
        ...
        void 0 === t && (t = {}),
          (this.handlePointerDown = function (e) {
            var t = n.dragging,
              ...
              i = r.longPressDelay;
            (t.minDistance =
              null != o ? o : e.isTouch ? 0 : wn.eventDragMinDistance),
              (t.delay = e.isTouch ? (null != i ? i : wn.longPressDelay) : 0);
          }),
          (this.handleDragStart = function (e) {
            e.isTouch &&
              n.dragging.delay &&
            ...
            function (e, t, u, c) {
              return Lo(
                ...
                Lo(
                  ...
                  Lo("div", { className: "fc-daygrid-day-bg" }, n.bgContent),
                ),
              );
            },
          );
          ...
          if (this.hiddenConsumes && s) {
            ...
            if (!a[c])
              if (this.allowReslicing) {
                var d = r(r({}, s), { span: la(s.span, n.span) });
            ...
            for (var l = 0, u = e; l < u.length; l++) {
              ...
              s.push(
                Lo(
                  ...
                  "bg-event" === t ? Lo(Ss, r({ seg: c }, Er(c, i))) : bs(t),
                ),
              );
            }
          ...
          if (!t.forPrint && null !== t.clientWidth) {
            if (e) {
              ...
              if (o.length) {
                ...
                this.setState({ framePositions: new Io(i, o, !0, !1) });
              }
            }
  ...
  var Nl = (function (e) {
      ...
      return (
        ...
        (t.prototype.buildRenderRange = function (t, n, r) {
          ...
          (/^(year|month)$/.test(n) &&
            ((s = i.startOfWeek(s)),
            (o = i.startOfWeek(l)).valueOf() !== l.valueOf() && (l = pt(o, 1))),
  ...
  function Ll(e) {
    ...
    return Lo(qo.Consumer, null, function (n) {
      if (!e.isLabeled)
        return Lo("td", { className: t.join(" "), "data-time": e.isoTimeStr });
      var r = n.dateEnv,
        o = n.options,
        i = n.viewApi,
        a =
        ...
        return (
          ...
          (t.renderHeadAxis = function (e, n) {
            ...
            var o = t.context.options,
              ...
              a =
                1 === gt(i.start, i.end) ? Eo(t.context, i.start, "week") : {};
                  ...
                  content: function (e) {
                    return Lo(
                      ...
                      Lo(
                        ...
                        e.tableColGroupNode,
                        Lo("tbody", null, Lo(Wl, { slatMetas: i })),
                      ),
                      Lo(
                        "div",
                        { className: "fc-timegrid-now-indicator-container" },
                        Lo(Na, { unit: h ? "minute" : "day" }, function (e) {
  ...
  var Bl = (function () {
      ...
      return (
        ...
        (e.prototype.computeDateTop = function (e, t) {
          return (
            t || (t = bt(e)), this.computeTimeTop(Gt(e.valueOf() - t.valueOf()))
          );
        }),
      ...
      return (
        ...
        (t.prototype.render = function () {
          ...
          return (
            ...
            Lo(
              fs,
              r({}, this.props, { defaultTimeFormat: nu, extraClassNames: e }),
            )
          );
        }),
        t
      ...
      return (
        ...
        (t.prototype.render = function () {
          ...
          return Lo(
            ...
            function (e, t) {
              return (
                t && Lo("div", { className: "fc-timegrid-col-misc", ref: e }, t)
              );
            },
          );
        }),
    ...
    iu = (function (e) {
      ...
      return (
        ...
        (t.prototype.renderFillSegs = function (e, t) {
          var n = this.props,
            o = this.context,
            i = tu(e, n.date, n.slatCoords, o.options.eventMinHeight).map(
              function (o, i) {
                var a = e[i];
                return Lo(
                  "div",
                  ...
                  "bg-event" === t
                    ? Lo(Ss, r({ seg: a }, Er(a, n.todayRange, n.nowDate)))
                    : bs(t),
                );
              },
            );
    ...
    pu = (function (e) {
      ...
      return (
        ...
        (t.prototype.render = function () {
          ...
          return Lo(Na, { unit: a ? "minute" : "day" }, function (l, u) {
            return Lo(
              uu,
              ...
              return Lo(
                ...
                (function (e, t, n, r, o) {
                  ...
                  if (!1 !== i.displayEventTime) {
                    ...
                    return Lo("td", { className: "fc-list-event-time" }, u);
                  }
                  return null;
                })(n, s, t, o, a),
                Lo(
        ...
        return Lo(
          ...
          function (e, t, n, r) {
            return Lo(
              ...
              Lo("div", { className: "fc-list-empty-cushion", ref: n }, r),
            );
          },
        );
      }),
          ...
          for (var a = [], d = 0; d < c.length; d += 1) {
            ...
            if (p) {
              var f = en(t[d]),
                h = u + "-" + f;
              a.push(
                Lo(Eu, { key: f, cellId: h, dayDate: t[d], todayRange: n }),
              );
              for (
  ...
  function Cu(e) {
    for (
      var t = bt(e.renderRange.start), n = e.renderRange.end, r = [], o = [];
      t < n;
