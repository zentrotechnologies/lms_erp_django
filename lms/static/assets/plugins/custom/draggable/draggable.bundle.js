!(function (t, e) {
  ...
  function i(t, e) {
    ...
    do {
      if (
        ((n = n.correspondingUseElement || n.correspondingElement || n), r(n))
      )
        return n;
      n = n?.parentNode || null;
    ...
    [y](t) {
      ...
      clearTimeout(this.mouseDownTimeout),
        o < i.mouse
          ...
          : l >= n &&
            (document.removeEventListener("mousemove", this[y]), this[b]());
    }
    [v](t) {
    ...
    [S](t) {
      ...
      Object.assign(this, { pageX: o, pageY: a }),
        ...
        (this.tapTimeout = window.setTimeout(() => {
          this[L]({ touches: [{ pageX: this.pageX, pageY: this.pageY }] });
        }, s.touch));
    }
    [D]() {
      const t = this.startEvent,
    ...
    [L](t) {
      ...
      Object.assign(this, i),
        ...
        o < n.touch
          ...
          : c >= e &&
            (document.removeEventListener("touchmove", this[L]), this[D]());
    }
    [x](t) {
      if (!this.dragging) return;
    ...
    DragSensor: class extends s {
      ...
      [Y](t) {
        ...
        if (
          ...
          return;
        if (this.options.handle && e && !i(e, this.options.handle)) return;
  ...
  function Q(t, e, r, n, s, i, o, a, l, c, h) {
    ...
    var u,
      ...
      p = { v: !1 };
    if ((0 !== i && (m.addInitializer = Z(s, p)), a || (0 !== i && 2 !== i)))
      if (2 === i)
        u = function (t) {
  ...
  function st(t, e, r, n, s, i, o, a, l, c, h) {
    ...
    for (var b = n ? 2 : 1, y = f.length - 1; y >= 0; y -= b) {
      var E;
      void 0 !==
        (m = Q(f[y], n ? f[y - 1] : void 0, s, d, l, i, o, a, g, c, h)) &&
        (et(i, m),
        0 === i
          ? (E = m)
          : 1 === i
  ...
  (Mt = Nt), ([Tt] = at(Mt, [[o, 2, "onSortableSorted"]], [], 0, void 0, r).e);
  ...
  var qt = Object.freeze({
    ...
    Snappable: class extends r {
      ...
      [Ot](t) {
        ...
        const r = new wt({ dragEvent: t, snappable: t.over || t.droppable });
        this.draggable.trigger(r),
          r.canceled() ||
      ...
      [Ft](t) {
        if (t.canceled()) return;
        const e = t.source || t.dragEvent.source,
          r = new xt({ dragEvent: t, snappable: t.over || t.droppable });
        this.draggable.trigger(r),
          r.canceled() ||
  ...
  const Ye = Symbol("onDragStart"),
    ...
    ze = {
      "drag:start": (t) =>
        `Picked up ${t.source.textContent.trim() || t.source.id || "draggable element"}`,
      "drag:stop": (t) =>
        `Released ${t.source.textContent.trim() || t.source.id || "draggable element"}`,
    },
    Pe = {
    ...
    Scrollable: class extends r {
      ...
      getScrollableElement(t) {
        return this.hasDefinedScrollableElements()
          ? i(t, this.options.scrollableElements) || document.documentElement
          : (function (t) {
              if (!t) return De();
  ...
  const Cr = {
    "sortable:sorted": function ({ dragEvent: t }) {
      const e =
        t.source.textContent.trim() || t.source.id || "sortable element";
      if (t.over) {
    ...
    (t.Sortable = class extends $e {
      ...
      [br](t) {
        ...
        const { source: e, over: r, overContainer: n } = t,
          s = this.index(e),
          i = new mr({ dragEvent: t, currentIndex: s, source: e, over: r });
