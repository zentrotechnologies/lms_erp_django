...
!(function (t, e) {
  ...
  var s = "undefined" != typeof window && void 0 !== window.document,
    ...
    A = "cropstart",
    P = "dblclick",
    I = d ? "pointerdown" : l ? "touchstart" : "mousedown",
        ...
        (i.width > i.maxWidth || i.width < i.minWidth) && (i.left = i.oldLeft),
          ...
          t.movable &&
            ...
            Ct(
              this.face,
              N,
              i.width >= e.width && i.height >= e.height ? g : u,
            ),
          ft(
            this.cropBox,
            pt(
            ...
            a && (p = n * (u = c / a)),
              ...
              ft(
                ...
                pt(
                  ...
                  zt(pt({ translateX: -h * u, translateY: -s * u }, t)),
                ),
              );
          }));
      },
    ...
    It = {
      bind: function () {
        var t = this.element,
          e = this.options,
          i = this.cropper;
        st(e.cropstart) && Ot(t, A, e.cropstart),
          st(e.cropmove) && Ot(t, j, e.cropmove),
          st(e.cropend) && Ot(t, S, e.cropend),
          st(e.crop) && Ot(t, R, e.crop),
          st(e.zoom) && Ot(t, Z, e.zoom),
          Ot(i, I, (this.onCropStart = this.cropStart.bind(this))),
          e.zoomable &&
            e.zoomOnWheel &&
          ...
          e.toggleDragModeOnDblclick &&
            Ot(i, P, (this.onDblclick = this.dblclick.bind(this))),
      ...
      unbind: function () {
        var t = this.element,
          e = this.options,
          i = this.cropper;
        st(e.cropstart) && kt(t, A, e.cropstart),
          st(e.cropmove) && kt(t, j, e.cropmove),
          st(e.cropend) && kt(t, S, e.cropend),
          st(e.crop) && kt(t, R, e.crop),
          st(e.zoom) && kt(t, Z, e.zoom),
          kt(i, I, this.onCropStart),
          e.zoomable &&
            e.zoomOnWheel &&
            kt(i, K, this.onWheel, { passive: !1, capture: !0 }),
          e.toggleDragModeOnDblclick && kt(i, P, this.onDblclick),
          ...
          t.changedTouches
            ...
            (a =
              Object.keys(o).length > 1 && n.zoomable && n.zoomOnTouch
                ...
                : Mt(t.target, N)),
            V.test(a) &&
              !1 !== Tt(this.element, A, { originalEvent: t, action: a }) &&
              (t.preventDefault(),
              (this.action = a),
              (this.cropping = !1),
              a === m && ((this.cropping = !0), vt(this.dragBox, W)));
        }
      },
      cropMove: function (t) {
        var e = this.action;
        if (!this.disabled && e) {
          var i = this.pointers;
          t.preventDefault(),
            !1 !== Tt(this.element, j, { originalEvent: t, action: e }) &&
              (t.changedTouches
                ? dt(t.changedTouches, function (t) {
        ...
        var e = this.canvasData,
          i = (function (t, e, i, a) {
            var n = e.aspectRatio,
              ...
              N = H.getContext("2d"),
              L = Xt({ aspectRatio: m, width: D, height: k }),
              z = Xt({ aspectRatio: m, width: T, height: W }, "cover"),
              ...
              j = Math.min(R.width, Math.max(S.width, r)),
              A = Math.min(R.height, Math.max(S.height, h)),
              P = [-j / 2, -A / 2, j, A];
            return (
              (H.width = mt(Y)),
              (H.height = mt(X)),
              ...
              if (a > 1) {
                this.url = (function (t, e) {
                  for (var i = [], a = new Uint8Array(t); a.length > 0; )
                    i.push(Rt.apply(null, lt(a.subarray(0, 8192)))),
                      (a = a.subarray(8192));
            ...
            value: function () {
              if (this.sized && !this.ready) {
                ...
                (this.container = a),
                  ...
                  e.highlight || vt(c, E),
                  e.cropBoxMovable && (vt(c, H), Ct(c, N, u)),
                  e.cropBoxResizable ||
          ...
          },
          {
            ...
            value: function () {
              if (this.ready) {
                ...
                t && t.removeChild(this.cropper), wt(this.element, O);
              }
            },
          },
          {
  ...
  return pt(Kt.prototype, At, Pt, It, Ut, qt, $t), Kt;
});
