...
class Candidate(AbstractBaseUser, TrackingModel):
    ...
    admission_number = models.CharField(max_length=255,null=True,blank=True,db_index=True,)
    admission_date = models.DateField(null=True,blank=True)
    admission_status = models.CharField(max_length=255,null=True,blank=True,default="Draft",  db_index=True)
    student_status = models.CharField(max_length=255,null=True,blank=True,default="Active",db_index=True)
    ...
    domicile_state = models.CharField(max_length=255,null=True,blank=True)
    ...
    abc_id = models.CharField(max_length=50,null=True,blank=True)
...
class AdmissionApplication(TrackingModel):
    ...
    photo_signature_status = models.CharField(max_length=50,default="Pending",)
    subject_selection_status = models.CharField(max_length=50,default="Pending",)
    ...
    admission_confirmation_status = models.CharField(max_length=50,default="Pending",)
    current_step = models.CharField(max_length=100,default="PERSONAL_INFO",)
...
class CandidateEducation(TrackingModel):
    candidate_id = models.CharField(max_length=255,null=True,blank=True,db_index=True,)
    application_id = models.CharField(max_length=255,null=True,blank=True,db_index=True,)
    previous_exam_passed = models.CharField(max_length=255,null=True,blank=True,)
